...
public class AmethystStage1Block extends DemonicaAngellicaModElements.ModElement {
	@ObjectHolder("demonica_angellica:amethyst_stage_1")
	public static final Block block = null;
	public AmethystStage1Block(DemonicaAngellicaModElements instance) {
		super(instance, 18);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("amethyst_stage_1");
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				...
				case NORTH :
				default :
					return VoxelShapes.create(0.3D, 0D, 0.3D, 0.7D, 0.3D, 0.7000000000000001D).withOffset(offset.x, offset.y, offset.z);
				case EAST :
				case WEST :
					return VoxelShapes.create(0.3D, 0.7D, 0D, 0.7D, 0.2999999999999999D, 0.3D).withOffset(offset.x, offset.y, offset.z);
				case UP :
				case DOWN :
					return VoxelShapes.create(0D, 0.7D, 0.7D, 0.3D, 0.3D, 0.2999999999999999D).withOffset(offset.x, offset.y, offset.z);
			}
		}
