...
public class AmethystStage2Block extends DemonicaAngellicaModElements.ModElement {
	@ObjectHolder("demonica_angellica:amethyst_stage_2")
	public static final Block block = null;
	public AmethystStage2Block(DemonicaAngellicaModElements instance) {
		super(instance, 19);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("amethyst_stage_2");
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				...
				case EAST :
				case WEST :
					return VoxelShapes.create(0.2D, 0.8D, 0D, 0.8D, 0.2D, 0.6D).withOffset(offset.x, offset.y, offset.z);
				case UP :
				case DOWN :
					return VoxelShapes.create(0D, 0.8D, 0.8D, 0.6D, 0.2D, 0.2D).withOffset(offset.x, offset.y, offset.z);
			}
		}
