...
public class CloudwoodSlabBlock extends DemonicaAngellicaModElements.ModElement {
	@ObjectHolder("demonica_angellica:cloudwood_slab")
	public static final Block block = null;
	public CloudwoodSlabBlock(DemonicaAngellicaModElements instance) {
		super(instance, 26);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("cloudwood_slab");
		}
