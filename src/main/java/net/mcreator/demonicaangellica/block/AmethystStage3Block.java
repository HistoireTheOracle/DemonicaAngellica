...
public class AmethystStage3Block extends DemonicaAngellicaModElements.ModElement {
	@ObjectHolder("demonica_angellica:amethyst_stage_3")
	public static final Block block = null;
	public AmethystStage3Block(DemonicaAngellicaModElements instance) {
		super(instance, 20);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("amethyst_stage_3");
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				...
				case EAST :
				case WEST :
					return VoxelShapes.create(0.2D, 0.8D, 0D, 0.8D, 0.2D, 0.8D).withOffset(offset.x, offset.y, offset.z);
				case UP :
				case DOWN :
					return VoxelShapes.create(0D, 0.8D, 0.8D, 0.8D, 0.2D, 0.2D).withOffset(offset.x, offset.y, offset.z);
			}
		}
